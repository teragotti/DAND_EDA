...
#even stronger seems to be the relationship to bound.sulfur.dioxide. That's why we build a new variable
ggplot(data = wine,
...
#random forest model
#for modeling I've consulted https://www.r-bloggers.com/predicting-wine-quality-using-random-forests/
wine$taste.top <- 
