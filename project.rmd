...
```{r echo=FALSE, warning=FALSE, Univariate_Plots_2nd_submission}
ggplot(wine,
       aes(x = quality.bucket)
       ) +
  geom_bar() +
...
### Plot Two
Feedback: "For final plot 2, including more than 3 features ina single figure might be difficult to interpret in this dataset. In this case, it is difficult to separate the different alcohol percentage. Please consider the following instead."
